...
class AboutIteration < Neo::Koan
  ...
  def test_break_works_with_each_style_iterations
    ...
    assert_equal array[0]+array[1]+array[2], sum
  end

  def test_collect_transforms_elements_of_an_array
    array = [1, 2, 3]
    new_array = array.collect { |item| item + 10 }
    assert_equal [array[0]+10, array[1]+10, array[2]+10], new_array

    # NOTE: 'map' is another name for the 'collect' operation
    another_array = array.map { |item| item + 10 }
    assert_equal [array[0]+10, array[1]+10, array[2]+10], another_array
  end
  ...
  def test_select_selects_certain_items_from_an_array
    ...
    assert_equal [array[1], array[3], array[5]], even_numbers
  ...
  def test_inject_will_blow_your_mind
    ...
    # Making me want to kill. What an awful way to loop with an initial value.
  end
